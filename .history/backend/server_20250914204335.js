...
app.post("/api/join", async (req, res) => {
  try {
    ...
    // Génération du PDF si inscription en ligne
...
// --- Routes comité et newsletter ---
app.use("/api/committee", require("./routes/committeeRoutes"));
app.use("/api/newsletter", require("./routes/newsletterRoutes"));

// =========================
// SERVIR FRONTEND (racine du projet)
// =========================
app.use(express.static(path.join(__dirname, ".."))); // <-- frontend à la racine
app.get(/.*/, (_req, res) =>
  res.sendFile(path.join(__dirname, "../index.html"))
);

// =========================
// SERVIR CERTIFICATS PDF
// =========================
