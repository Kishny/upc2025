...
app.post("/api/join", async (req, res) => {
  try {
    ...
    res.json({
      ok: true,
      id: memberDoc._id,
      pdfPath: pdfPath ? `certificates/certificate_${memberDoc._id}.pdf` : null,
    });
  } catch (err) {
...
// Servir documents.html spécifiquement
...
// Route catch-all pour SPA - doit être après toutes les autres routes
