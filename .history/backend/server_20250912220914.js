...
app.post("/api/join", async (req, res) => {
  try {
    console.log("Données reçues :", req.body); // ← log pour voir tout ce qui arrive
    ...
    console.log("Contribution mappée :", contribution);
    ...
    try {
      ...
      // On ne fait pas planter le serveur si le mail échoue
    }
...
app.post("/api/newsletter", async (req, res) => {
  try {
    ...
    // Ici tu peux créer un document Newsletter si tu veux stocker
    // Ou juste envoyer un mail de confirmation
    await sendMail({
