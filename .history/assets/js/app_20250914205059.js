...
function updateFormDisplay() {
  ...
  form.classList.toggle("form-org", memberType === "organization");
  form.classList.toggle("form-individual", memberType !== "organization");
