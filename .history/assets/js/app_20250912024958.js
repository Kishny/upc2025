...
Object.assign(DICT.en, {
  ...
  axis_audit_text:
    "Evaluate institutions, finances, infrastructure and operations to build solid reforms.",
  axis_peace_title: "Peace – Reconciliation – National Cohesion",
  axis_peace_text:
    "Bring peace to conflict regions, reconcile the Nation, restore citizen trust.",
  axis_reforms_title: "Political and Institutional Reforms",
  axis_reforms_text:
    "New Constitution, two-round electoral code, rule of law and good governance.",
  axis_growth_title: "Economic Growth and Sustainable Development",
  axis_growth_text:
    "Break with extraversion and lay the foundations of an industrial and digital economy.",
  axis_human_title: "Human Capital Development & Social Solidarity",
  axis_human_text:
    "Educational reform, universal health care, fight against youth unemployment, equal opportunities.",
  axis_world_title: "Pan-African and International Influence",
  axis_world_text:
    "Position Cameroon as a key player in Africa and in a multipolar world.",
});
...
const STEPS_I18N = {
  fr: {
    steps_title: "Les grandes étapes de la Refondation du Cameroun (3–5 ans)",

    step1_title: "Mettre en place les organes de Transition",
    step1_president_title: "Président de Transition",
    step1_president_text: "Mandat unique et limité, symbole de la Refondation.",
    step1_gov_title: "Gouvernement d’Union Nationale de Transition",
    step1_gov_text:
      "Technocrates issus de toutes les forces vives, chargés de mettre en œuvre le programme et d’organiser les élections.",
    step1_assembly_title: "Assemblée nationale de Transition",
    step1_assembly_text: "Légifère et contrôle l’action du gouvernement.",
    step1_court_title: "Cour constitutionnelle",
    step1_court_text:
      "Veille à la constitutionnalité des actes durant la Transition.",

    step2_title: "Redonner la parole et le pouvoir au Peuple",
    step2_assises_title: "Assises Nationales de Refondation",
    step2_assises_text:
      "Consultations locales et régionales pour établir les valeurs du vivre-ensemble et définir le cahier des charges du gouvernement.",
    step2_etats_title: "États Généraux Sectoriels",
    step2_etats_text:
      "Analyse des enjeux sectoriels et propositions de solutions techniques et sociales.",
    step2_votes_title: "Référendum et élections générales",
    step2_votes_text:
      "Adoption de la nouvelle Constitution et des codes, puis retour à la pleine légitimité démocratique.",
    candidate_pillar_1: "Paix & sécurité",
    candidate_pillar_1_desc:
      "Mesures immédiates pour l’apaisement et la sécurité des citoyens.",
    candidate_pillar_2: "Réformes politiques",
  ...
  en: {
    steps_title: "Key stages of Cameroon’s Refoundation (3–5 years)",

    step1_title: "Establish the Transition institutions",
    step1_president_title: "Transitional President",
    step1_president_text:
      "Single, limited mandate; symbol of the Refoundation.",
    step1_gov_title: "Government of National Unity (Transition)",
    step1_gov_text:
      "Technocrats from all constituencies, in charge of implementing the program and organizing elections.",
    step1_assembly_title: "Transitional National Assembly",
    step1_assembly_text: "Legislates and oversees government action.",
    step1_court_title: "Constitutional Court",
    step1_court_text:
      "Ensures constitutionality of acts during the Transition.",

    step2_title: "Give voice and power back to the People",
    step2_assises_title: "National Refoundation Conferences",
    step2_assises_text:
      "Local and regional consultations to define shared values and the government’s roadmap.",
    step2_etats_title: "Sectoral General Conferences",
    step2_etats_text:
      "Analysis of sectoral challenges and proposals for technical and social solutions.",
    step2_votes_title: "Referendum and general elections",
    step2_votes_text:
      "Adoption of the new Constitution and codes, then full democratic legitimacy restored.",
  },
};
...
DICT.fr = {
  ...
  about_goals_1_p1:
    "Fédérer toutes les forces du changement autour d’un Programme Commun de Transition et de Refondation.",
  about_goals_2_p1: "Présenter un ",
  about_goals_2_strong: "candidat consensuel du Peuple",
  about_goals_2_p2: " à la présidentielle 2025.",
  about_goals_3_p1: "Mener une ",
  about_goals_3_strong: "campagne populaire et participative",
  about_goals_4_p1: "Assurer la ",
  about_goals_4_strong: "présence et la surveillance",
  about_goals_4_p2: " dans tous les bureaux de vote.",
  about_goals_5_p1: "Gagner l’élection et",
  about_goals_5_strong: " défendre la victoire du peuple",
};
...
DICT.en = {
  ...
  about_goals_1_p1:
    "Bring together all forces for change around a Common Programme of Transition and Refoundation.",
...
// Après avoir défini DICT.fr et DICT.en :
Object.assign(DICT.fr, STEPS_I18N.fr);
Object.assign(DICT.en, STEPS_I18N.en);

// (Ton système i18n applique déjà la traduction via data-i18n)
