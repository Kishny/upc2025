...
const DICT = {
  ...
  axis_audit_text: "Évaluer institutions, finances, infrastructures et fonctionnement pour bâtir des réformes solides.",
  axis_peace_title: "Paix – Réconciliation – Cohésion nationale",
  axis_peace_text: "Ramener la paix dans les régions en conflit, réconcilier la Nation, restaurer la confiance citoyenne.",
  axis_reforms_title: "Réformes politiques et institutionnelles",
  axis_reforms_text: "Nouvelle Constitution, code électoral à deux tours, État de droit et bonne gouvernance.",
  axis_growth_title: "Croissance économique et développement durable",
  axis_growth_text: "Rompre avec l’extraversion et poser les bases d’une économie industrielle et numérique.",
  axis_human_title: "Développement du capital humain & solidarité sociale",
  axis_human_text: "Réforme éducative, santé universelle, lutte contre le chômage des jeunes, égalité des chances.",
  axis_world_title: "Rayonnement panafricain et international",
  axis_world_text: "Positionner le Cameroun comme acteur clé en Afrique et dans un monde multipolaire.",
}
  },
  en: {
