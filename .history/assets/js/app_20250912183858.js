...
if (video) {
  video.loop = true;
  video.muted = true; // autoplay garanti sur la plupart des navigateurs
...
function wireFormBackend(id, url, okMessage) {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    // ⚡ Pour le rôle 'Don', on s'assure qu'il est bien transmis
    if (!formData.role && id === "form-adhesion") formData.role = "Don";
