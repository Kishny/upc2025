...
const DICT_ABOUT = {
  fr: {
    ...
    about_intro_title: "Historique & mission",
    // Colle ici les paragraphes envoyés par le client (FR)
    about_intro_p1: "Texte historique — à remplacer par le contenu client.",
    about_intro_p2: "Mission générale — à remplacer par le contenu client.",

    about_mission_title: "Mission de l’UPC 2025",
    about_mission_li1: "Fédérer les forces citoyennes et politiques.",
    about_mission_li2: "Garantir une alternance pacifique et démocratique.",
    about_mission_li3: "Protéger le vote et renforcer l’État de droit.",

    about_objectives_title: "Objectifs de la coalition",
    about_objectives_bloc1_title: "Objectif 1",
    about_objectives_bloc1_text:
      "Détail de l’objectif 1 — remplacer par le texte client.",
    about_objectives_bloc2_title: "Objectif 2",
    about_objectives_bloc2_text:
      "Détail de l’objectif 2 — remplacer par le texte client.",
    about_objectives_bloc3_title: "Objectif 3",
    about_objectives_bloc3_text:
      "Détail de l’objectif 3 — remplacer par le texte client.",

    about_principles_title:
      "Principes du Programme Commun de Transition et de Refondation",
    about_principles_li1: "Paix, sécurité et réconciliation.",
    about_principles_li2: "Réformes politiques et institutionnelles.",
    about_principles_li3: "Croissance économique inclusive.",
    about_principles_li4: "Développement humain (éducation, santé, emploi).",
    about_principles_li5: "Rayonnement international et panafricanisme.",

    about_cta_title: "Aller plus loin",
    about_cta_text:
      "Découvrez la structure complète du Programme Commun et les axes de mise en œuvre.",
    goto_program: "Voir le Programme",
  },

  en: {
    about_h1: "About",

    about_intro_title: "Background & Mission",
    // Provide a quick English version (replace with client’s official EN text)
    about_intro_p1: "Historical background — replace with client content.",
    about_intro_p2: "Overall mission — replace with client content.",

    about_mission_title: "UPC 2025 Mission",
    about_mission_li1: "Unite civic and political forces.",
    about_mission_li2: "Ensure a peaceful, democratic alternation.",
    about_mission_li3: "Protect the vote and strengthen the rule of law.",

    about_objectives_title: "Coalition Objectives",
    about_objectives_bloc1_title: "Objective 1",
    about_objectives_bloc1_text:
      "Details for objective 1 — replace with client content.",
    about_objectives_bloc2_title: "Objective 2",
    about_objectives_bloc2_text:
      "Details for objective 2 — replace with client content.",
    about_objectives_bloc3_title: "Objective 3",
    about_objectives_bloc3_text:
      "Details for objective 3 — replace with client content.",

    about_principles_title:
      "Principles of the Common Transition & Refoundation Program",
    about_principles_li1: "Peace, security and reconciliation.",
    about_principles_li2: "Political & institutional reforms.",
    about_principles_li3: "Inclusive economic growth.",
    about_principles_li4: "Human development (education, health, jobs).",
    about_principles_li5: "International outreach & Pan-Africanism.",

    about_cta_title: "Go further",
    about_cta_text:
      "Explore the full Common Program and its implementation pillars.",
    goto_program: "View the Program",
  },
};
