...
const DICT = {
  fr: {
    about_main_title: "À propos de l’UPC 2025",
    ...
    about_who_p2:
      "L’Union pour le Changement n’est pas un attelage disparate... objectif commun : gagner la présidentielle 2025 et refonder le Cameroun pendant une période de transition de 3 à 5 ans.",
    about_roots_title: "Racines historiques",
    about_roots_p1:
      "L’UPC 2025 puise ses racines dans l’Union pour le Changement de 1992...",
    about_roots_p2:
      "En tirant les leçons du passé, le « Groupe de Douala », sous la houlette d’Anicet Ekane, Djeukam Tchameni et Sam Mbaka, a structuré l’appel du peuple...",
    ...
    about_goal_3: "Mener une campagne populaire et participative.",
    about_goal_4:
      "Assurer la présence et la surveillance dans tous les bureaux de vote.",
    about_goal_5: "Gagner l’élection et défendre la victoire du peuple.",
    about_source: "Extrait du document « Section 1 : À propos ».",
    about_structure_title: "Structure organisationnelle",
    about_structure_p1:
      "L’Union pour le Changement en 2025 est avant tout une initiative du Peuple camerounais...",
    about_structure_p2:
      "L’unité de base est le citoyen conscient qui s’inscrit, promeut le Programme Commun, participe à la campagne de proximité, va voter et surveille son vote — d’où le slogan : « Le 12 octobre 2025, tout dépend de moi ».",
    about_structure_p3:
      "Dans chaque commune, les citoyens se constituent en Comités locaux... logiciel de décompte parallèle.",
  },
  en: {
    about_main_title: "About UPC 2025",
    about_who_title: "Who are we?",
    about_who_p1:
      "The Union for Change 2025 (UPC 2025) is a broad coalition of political parties, civil society associations, personalities and citizens united around a Common Program of Transition and Refoundation to present a Consensus Candidate of the People for the October 2025 presidential election.",
    about_who_p2:
      "The Union for Change is not a disparate alliance... common goal: to win the 2025 presidential election and refound Cameroon during a transition period of 3 to 5 years.",
    about_roots_title: "Historical roots",
    about_roots_p1:
      "UPC 2025 draws its roots from the Union for Change of 1992...",
    about_roots_p2:
      "Learning from past experiences, the 'Douala Group', led by Anicet Ekane, Djeukam Tchameni and Sam Mbaka, structured the people's call...",
    about_goals_title: "Our objectives",
    about_goal_1:
      "Unite all forces of change around a Common Program of Transition and Refoundation.",
    about_goal_2:
      "Present a Consensus Candidate of the People for the 2025 presidential election.",
    about_goal_3: "Lead a popular and participatory campaign.",
    about_goal_4: "Ensure presence and monitoring in all polling stations.",
    about_goal_5: "Win the election and defend the people's victory.",
    about_source: "Excerpt from the document 'Section 1: About'.",
    about_structure_title: "Organizational structure",
    about_structure_p1:
      "UPC 2025 is above all an initiative of the Cameroonian People...",
    about_structure_p2:
      "The basic unit is the conscious citizen who registers, promotes the Common Program, participates in the grassroots campaign, goes to vote and monitors their vote — hence the slogan: 'On October 12, 2025, it all depends on me'.",
    about_structure_p3:
      "In each municipality, citizens form Local Committees... parallel counting software.",
  },
};
